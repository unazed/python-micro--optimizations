...
I don't really like any of the people that, when you talk about optimization, say *"oh if you're going for speed, why use Python and not some natively faster language like <insert-unrelated-language>?"* - my answer would be that I just guess it just piques my curiosity to make my program as fast as it can be.

Plus learning another language for some speed gains? That's too much work and effort, and Python is a perfect tool for people that don't want to spend too much time coding something.
